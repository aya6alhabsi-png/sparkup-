...
import {FaUserCircle,FaEnvelope,FaPhone,FaKey,FaLightbulb,FaCalendarAlt,FaClipboardList,FaRobot,FaEdit,FaLanguage,FaMoon,} from "react-icons/fa";
...
function InnovatorPage() {
  ...
  const handleCardClick = (key) => {
    if (key === "events" || key === "myEvents") {
      ...
      alert(
        `${key} – this is a UI demo card. Later it can open the detailed page.`
      );
    }
  };
  ...
  return (
    ...
    >
              ...
              <CardBody className="d-flex flex-column p-3 p-md-4">
                ...
                <div className="d-flex flex-column align-items-center mb-4">
                  ...
                  <div className="d-flex align-items-center gap-2 mt-2">
                    <span className="fw-semibold">Hi {innovatorName}</span>
                    <button
                      type="button"
      ...
      <Modal isOpen={aiModalOpen} toggle={toggleAiModal} centered>
        <ModalHeader toggle={toggleAiModal}>AI Chatbot Help</ModalHeader>
        <ModalBody></ModalBody>
        <ModalFooter>
