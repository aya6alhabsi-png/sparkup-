...
function InnovatorPage() {
  ...
  const mainCards = [
    ...
    {
      key: "myIdeas",
      title: lang === "ar" ? "أفكاري وتقدمي" : "My Ideas & Progress",
      text:
        lang === "ar"
          ? "شاهد كل أفكارك وحالاتها: بانتظار، قيد المراجعة، معروضة، ممولة."
          : "View all your ideas with status: Pending, In Review, Presented, Funded.",
    ...
    },
    {
      ...
      text:
        lang === "ar"
          ? "تابع الفعاليات التي انضممت لها والشهادات (ميزة قادمة)."
          : "Keep track of the events you joined and certificates earned (future feature).",
  ...
  return (
    ...
    >
              ...
              <Col className="d-flex align-items-center gap-2">
                ...
                <div>
                  ...
                  <div className="small" style={{ color: "var(--app-muted)" }}>
                    {lang === "ar"
                      ? "الرئيسية · أفكارك وفعالياتك"
                      : "Innovator Home · Your ideas, events & progress"}
                  </div>
                </div>
              </Col>
            </Row>
      ...
      <Modal isOpen={aiModalOpen} toggle={toggleAiModal} centered>
        <ModalHeader toggle={toggleAiModal}>AI Chatbot</ModalHeader>
        <ModalBody />
        <ModalFooter>
